...
export class Dashboard extends Component<{}, MyState>{
    ...
    componentDidMount(){
        axios.get("http://18.222.128.62:7060/list")
        .then(res =>{
                    ...
                    <Row>
                        <Col sm="4">
                            <Card body>
                                ...
                                <CardText>
                                    with supporting text below is natural
                                </CardText>
                        ...
                        <Col sm="4">
                            <Card body>
                                <CardTitle tag="h5">
                                    <IoSchoolOutline className="font-size-xl"/>20 teacher
                                </CardTitle>
...
function deleteStudent(id: any): void {
    axios.post(`http://18.222.128.62:7060/delete/${id}`)
}
